...
from conan.tools.files import apply_conandata_patches, export_conandata_patches, get, copy, rm, rmdir, save, replace_in_file
...
class EasyProfilerConan(ConanFile):
    ...
    def source(self):
        ...
        replace_in_file(self, os.path.join(self.source_folder, "CMakeLists.txt"), "cmake_minimum_required(VERSION 3.0)", "cmake_minimum_required(VERSION 3.5...${CMAKE_VERSION})")
